...
function empiezaConNueve(n) {
  ...
  var array = [];
  if(n >= 1000){
    var cifra3 = Math.floor(n/1000);
    array.push(cifra3)
  }else if(n >= 100){
    var cifra2 = Math.floor(n/100);
    array.push(cifra2)
  }else if(n >= 10){
    var cifra1 = Math.floor(n/10);
    array.push(cifra1)
  }else{
    var cifra = Math.floor(n);
    array.push(cifra)
  }
  console.log(array[0])
  if(array[0] === 9){
...
function mesesDelAño(array) {
  ...
  // Tu código:
  let newArray = [];
  //let newArray = array.filter(x => x === "Enero"  === "Marzo"  === "Noviembre")
  for (var i=0 ; i < array.length; i++){
...
function breakStatement(numero) {
  ...
  for(var i=0; i < 10;i++){
    var valorSuma = (numero += 2)
    newArray.push(valorSuma)
